...
const skills = [
  ...
  "MySql", "JavaScript", "AWS", "Vercel", "Tailwind CSS", 
   "Figma", "Git", "GitHub Actions",
];

export const Hero = () => {
  // FIX: Added a consistent wrapper for the <img> icons to match Lucide's dimensions
  const socialLinks = [
    ...
    { 
      icon: (props) => (
        <div className={props.className + " flex items-center justify-center overflow-hidden"}>
          <img src="/icons/geeksforgeeks.svg" alt="GFG" className="w-full h-full object-contain brightness-0 invert opacity-70 group-hover:opacity-100" />
        </div>
      ), 
    ...
    { 
      icon: (props) => (
        <div className={props.className + " flex items-center justify-center overflow-hidden"}>
          <img src="/icons/leetcode.svg" alt="LeetCode" className="w-full h-full object-contain brightness-0 invert opacity-70 group-hover:opacity-100" />
        </div>
      ), 
      href: "https://leetcode.com/shivi23gu/" 
    },
  ];
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              ...
              <AnimatedBorderButton
                as="a"
                href="https://drive.google.com/uc?export=download&id=1pp2lsImjMwDrnrB6WRrURqGsSTQisKKO"
                target="_blank"
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {socialLinks.map((social, idx) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group p-2 rounded-full glass hover:bg-primary/10 hover:text-primary transition-all duration-300"
                >
            ...
            <div className="relative max-w-md mx-auto">
              ...
              <div className="relative glass rounded-3xl p-2 glow-border">
                ...
                <div className="absolute -top-4 -left-4 glass rounded-xl px-4 py-3 animate-float animation-delay-500">
                  ...
                  <div className="text-xs text-muted-foreground">Learning & Projects</div>
                </div>
              </div>
            </div>
          </div>
